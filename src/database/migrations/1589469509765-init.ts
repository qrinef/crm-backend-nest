...
export class init1589469509765 implements MigrationInterface {
    name = 'init1589469509765'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "clients" ("id" SERIAL NOT NULL, "email" character varying NOT NULL, "phone" character varying, "name" character varying NOT NULL, "surname" character varying, CONSTRAINT "PK_f1ab7cf3a5714dbc6bb4e1c28a4" PRIMARY KEY ("id"))`, undefined);
        ...
        await queryRunner.query(`ALTER TABLE "orders" ADD CONSTRAINT "FK_1457f286d91f271313fded23e53" FOREIGN KEY ("clientId") REFERENCES "clients"("id") ON DELETE CASCADE ON UPDATE NO ACTION`, undefined);
